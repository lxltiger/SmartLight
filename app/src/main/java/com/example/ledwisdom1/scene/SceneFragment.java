 ...
 */
public class SceneFragment extends Fragment implements CallBack{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentSceneBinding mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_scene, container, false);
    ...
    private OnHandleSceneListener mHandleSceneListener = new OnHandleSceneListener() {
        ...
        public void onEditClick(Scene scene) {
            ...
            GroupSceneActivity.start(getContext(),GroupSceneActivity.ACTION_ADD_SCENE);
        }
    };
