...
public class DeviceEvent extends DataEvent<DeviceInfo> {
     ...
     *
     * @see LightAdapter#STATUS_CONNECTING
     * @see LightAdapter#STATUS_CONNECTED
     * @see LightAdapter#STATUS_LOGINING
     * @see LightAdapter#STATUS_LOGIN
     * @see LightAdapter#STATUS_LOGOUT
     * @see LightAdapter#STATUS_UPDATING_MESH
     * @see LightAdapter#STATUS_UPDATE_MESH_COMPLETED
     * @see LightAdapter#STATUS_UPDATE_MESH_FAILURE
     * @see LightAdapter#STATUS_UPDATE_ALL_MESH_COMPLETED
     * @see LightAdapter#STATUS_GET_LTK_COMPLETED
     * @see LightAdapter#STATUS_GET_LTK_FAILURE
     * @see LightAdapter#STATUS_GET_FIRMWARE_COMPLETED
     * @see LightAdapter#STATUS_OTA_PROGRESS
     * @see LightAdapter#STATUS_OTA_COMPLETED
     * @see LightAdapter#STATUS_OTA_FAILURE
     */
